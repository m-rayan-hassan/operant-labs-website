      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 mb-20 text-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl italic mb-6 leading-tight tracking-tight">
            Ready to Turn Your Vision <span className="text-electric-cyan">Into Reality?</span>
          </h1>
          <p className="text-lg text-on-surface-variant font-light leading-relaxed">
            Partner with Operant Labs to build intelligent software, automate business processes, and create digital experiences that drive measurable results. We're just a conversation away.
          </p>
        </motion.div>
      </section>
          ...
          >
            ...
            <div>
              ...
              <p className="text-on-surface-variant text-sm font-light leading-relaxed">
                Every good project starts with a conversation. Whether you're planning new software, automation, AI, or a wider digital transformation, our team is ready to help.
              </p>
            </div>
                ...
                <form
                  onSubmit={(e) => {
                    ...
                    if (phone && phone.length !== selectedCountry.length) {
                      alert(`Please enter a valid ${selectedCountry.label} phone number with exactly ${selectedCountry.length} digits, or leave it empty.`);
                      return;
                    }
                    alert("Thank you. Our solutions architect will contact you shortly.");
                  }}
                  className="space-y-6"
                >
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] font-semibold text-on-surface-variant uppercase tracking-widest">Primary Interest</label>
                    <select
                      className="w-full bg-surface-dim border border-border-subtle rounded-xl px-4 py-3.5 text-sm text-foreground focus:outline-none focus:border-electric-cyan focus:ring-1 focus:ring-electric-cyan transition-all appearance-none cursor-pointer"
                    >
                      <option className="bg-background text-foreground">Custom Software Development</option>
                      <option className="bg-background text-foreground">Intelligent Business Automation</option>
                      <option className="bg-background text-foreground">Artificial Intelligence / LLMs</option>
                      <option className="bg-background text-foreground">Cloud Infrastructure & DevOps</option>
                      <option className="bg-background text-foreground">Data Analytics & BI</option>
                      <option className="bg-background text-foreground">Strategic Technology Advisory</option>
                    </select>
                  </div>

                  <div className="space-y-2">
                    <label className="text-[11px] font-semibold text-on-surface-variant uppercase tracking-widest">Project Outline</label>
                    <textarea
                      rows={4}

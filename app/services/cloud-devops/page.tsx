    ...
    <div className="min-h-screen pt-32 pb-24">
      <section className="max-w-7xl mx-auto px-6 lg:px-8 mb-24 grid lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
          <div className="section-number mb-6">Service 04</div>
          <h1 className="text-4xl md:text-5xl italic font-normal mb-6 leading-tight">
            Infrastructure That Scales <span className="text-electric-cyan">As Fast As You Do</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 mb-24 grid md:grid-cols-2 gap-12">
        <div className="glass-panel p-8 md:p-10 rounded-3xl">
          ...
          <ul className="space-y-4">
            {[
              "Cloud migration and cost optimisation (AWS, Azure, GCP)",
              "Hybrid and multi-cloud architecture",
              "CI/CD pipeline setup and automation",
              "Containerisation with Docker and Kubernetes",
              "Infrastructure as code and environment management",
              "24/7 monitoring and managed cloud support"
            ].map((item, i) => (
        ...
        <div className="glass-panel p-8 md:p-10 rounded-3xl bg-surface/30">
          ...
          <ul className="space-y-6">
            {[
              { title: "Faster, Safer Releases", desc: "Automate deployment pipelines to eliminate manual steps and reduce downtime." },
              { title: "Cost Efficiency", desc: "Lower infrastructure costs through expertly right-sized cloud resources." },
              { title: "High Resilience", desc: "Improved uptime, fault tolerance, and comprehensive disaster recovery protocols." }
            ].map((item, i) => (

    ...
    <div className="min-h-screen pt-32 pb-24">
      <section className="max-w-7xl mx-auto px-6 lg:px-8 mb-24 grid lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
          <div className="section-number mb-6">Service 03</div>
          <h1 className="text-4xl md:text-5xl italic font-normal mb-6 leading-tight">
            Empowering Businesses with <span className="text-electric-cyan">Intelligent AI Solutions</span>
          </h1>
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} className="relative h-[400px] lg:h-[500px] rounded-2xl overflow-hidden border border-border-subtle">
          <Image src="https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=1965&auto=format&fit=crop" alt="Abstract AI Neural Network" fill className="object-cover" />
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 mb-24 grid md:grid-cols-2 gap-12">
        <div className="glass-panel p-8 md:p-10 rounded-3xl">
          ...
          <ul className="space-y-4">
            {[
              "AI-powered virtual assistants and conversational chatbots",
              "Intelligent document processing",
              "Predictive analytics and recommendation systems",
              "AI-powered workflow automation",
              "AI knowledge management and natural language search"
            ].map((item, i) => (
        ...
        <div className="glass-panel p-8 md:p-10 rounded-3xl bg-surface/30">
          ...
          <ul className="space-y-6">
            {[
              { title: "Smarter Decision Making", desc: "Gain a competitive edge with rapid, actionable insights from real-time data analysis." },
              { title: "Better Customer Experience", desc: "Deliver hyper-personalisation and seamless 24/7 support capabilities." },
              { title: "Scale Efficiency", desc: "Significantly lower costs and improve accuracy as your operations grow." }
            ].map((item, i) => (
